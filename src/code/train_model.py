...
#
# ------------------------------------------------------------
CHECKPOINT_NAME = "best_model_run_5_seed_7_actual_experiment.pt"
OUTPUT_CSV = "trained_model_results_run_5_seed_7_actual_experiment.csv"
MODEL_SAVE_PATH = "trained_model_run_5_seed_7_actual_experiment.pt"
BATCH_SIZE = 32
EPOCHS = 4
LEARNING_RATE = 3e-5
